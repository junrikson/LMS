<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GeneralJournalPangkalPinangB.aspx.vb" Inherits="LMS.GeneralJournalPangkalPinangB" %>
...
<head id="Head1" runat="server">
    <title>Jurnal Umum pangkal Pinang B</title>
...
<body>
   ...
   <div class="formtitle">
        <b>Jurnal Umum pangkal Pinang B</b>  
   </div><br />
        <div class="div_input">
            <div class="div_umum">
