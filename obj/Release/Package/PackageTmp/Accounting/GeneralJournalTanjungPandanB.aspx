<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GeneralJournalTanjungPandanB.aspx.vb" Inherits="LMS.GeneralJournalTanjungPandanB" %>
...
<head id="Head1" runat="server">
    <title>Jurnal Umum Tanjung Pandan B</title>
...
<body>
   ...
   <div class="formtitle">
        <b>Jurnal Umum Tanjung Pandan B</b>  
   </div><br />
        <div class="div_input">
            <div class="div_umum">
          ...
          <table width="100%" cellpadding="4" cellspacing="0">
            ...
            <tr>
                <td style="border-top:#465946 1px solid;">
                    <asp:CheckBox ID="ChkPBM" runat="server" Text="PBM" Font-Bold="True" 
                        Font-Size="12pt" />
                </td>
            </tr>
            <tr>
...
<SettingsDetail ShowDetailRow="True" AllowOnlyOneMasterRowExpanded="True"></SettingsDetail>
		...
		<asp:SqlDataSource ID="SqlDataSourceAccount" runat="server" ConnectionString="<%$ ConnectionStrings:LigitaConString %>"
			 SelectCommand="SELECT ID, [Types],[Types] + '.' + SUBSTRING(Code,6,LEN(Code) -5 ) as Code, Name, Levels, Lokasi FROM ChartOfAccount WHERE Levels <> 1 AND Parent <> 'TOP' and status = 1 and lokasi = 3 ORDER BY Code">
		</asp:SqlDataSource>
