<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GeneralJournalB.aspx.vb" Inherits="LMS.GeneralJournalB" %>
...
<SettingsDetail ShowDetailRow="True" AllowOnlyOneMasterRowExpanded="True"></SettingsDetail>
		...
		<asp:SqlDataSource ID="SqlDataSourceAccount" runat="server" ConnectionString="<%$ ConnectionStrings:LigitaConString %>"
			 SelectCommand="SELECT ID, [Types],[Types] + '.' + SUBSTRING(Code,6,LEN(Code) -5 ) as Code, Name, Levels, Lokasi FROM ChartOfAccount WHERE status = 1 AND Parent <> 'TOP' and Levels <> 1 ORDER BY Code">
		</asp:SqlDataSource>
