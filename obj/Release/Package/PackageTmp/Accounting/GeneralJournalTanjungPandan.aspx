<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GeneralJournalTanjungPandan.aspx.vb" Inherits="LMS.GeneralJournalTanjungPandan" %>
...
<head runat="server">
    <title>Jurnal Umum Tanjung Pandan</title>
...
<body>
   ...
   <div class="formtitle">
        <b>Jurnal Umum Tanjung Pandan</b>  
   </div><br />
        <div class="div_input">
            <div class="div_umum">
...
<SettingsDetail ShowDetailRow="True" AllowOnlyOneMasterRowExpanded="True"></SettingsDetail>
		...
		<asp:SqlDataSource ID="SqlDataSourceAccount" runat="server" ConnectionString="<%$ ConnectionStrings:LigitaConString %>"
			 SelectCommand="SELECT ID, [Types],[Types] + '.' + SUBSTRING(Code,6,LEN(Code) -5 ) as Code, Name, Levels, Lokasi FROM ChartOfAccount WHERE status = 1 AND Parent <> 'TOP'  and Levels <> 1 and lokasi = 3 ORDER BY Code">
		</asp:SqlDataSource>
