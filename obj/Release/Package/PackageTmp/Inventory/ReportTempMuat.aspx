<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportTempMuat.aspx.vb" Inherits="LMS.ReportTempMuat" %>
...
<title>Report Manifest</title>
   ...
   function getmb() {
    ...
    function getitems() {
        returnValue = Showdialogwarehouse('MuatBarangSementara', 'Arg', '610', '450');
        if (returnValue) {
            var comp = new Array();
            comp = returnValue.split(";");
    ...
    function GetNoKontainer() {
        returnValue = Showdialogwarehouse('StuffingSementara', 'Arg', '610', '450');
        if (returnValue) {
            var comp = new Array();
            comp = returnValue.split(";");
    ...
    function GetNoInputKontainer() {
        returnValue = Showdialogwarehouse('LoadContainerSementara', 'Arg', '610', '450');
        if (returnValue) {
            var comp = new Array();
            comp = returnValue.split(";");
...
<body>
    ...
    <div class="formtitle">Report Surat Muat dan Manifest Sementara</div>
...
<div>
            ...
            <dxwgv:ASPxGridView ID="Grid_History" runat="server" 
                    ...
                    Width="569px" ClientInstanceName = "grid_manifest" SettingsDetail-AllowOnlyOneMasterRowExpanded="True" SettingsDetail-ShowDetailRow="True">
                    <styles>
			        ...
			        <Columns>
                        ...
                        <dxwgv:GridViewDataDateColumn FieldName="Depart_Date" Name="Depart_Date" 
                            Visible="true" VisibleIndex= "2" Caption="Tanggal Keberangkatan" >
						...
						<dxwgv:GridViewDataColumn FieldName="Kapal" Name="Kapal" 
                            Visible="false" VisibleIndex= "3" Caption="Kapal" >
						</dxwgv:GridViewDataColumn>
						<dxwgv:GridViewDataColumn FieldName="Nama_Kapal" Name="Nama_Kapal" 
                            VisibleIndex= "4" Caption="Nama Kapal" >
						</dxwgv:GridViewDataColumn>
						<dxwgv:GridViewDataColumn FieldName="NoPelayaran" Name="NoPelayaran" 
                            VisibleIndex= "4" Caption="Nomor Pelayaran" >
						</dxwgv:GridViewDataColumn>

                        <dxwgv:GridViewDataColumn Caption="#" Name="Print" VisibleIndex="5" Width="1%">
                                            <dataitemtemplate>
                                                <asp:LinkButton ID="tbPrint" runat="server" CommandName="Print" 
                                                    ToolTip="Print">Preview</asp:LinkButton>
                                            </dataitemtemplate>
                        </dxwgv:GridViewDataColumn>
                    </Columns>
                    <Templates>
