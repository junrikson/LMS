<%@ Page Language="VB" Strict="true" AutoEventWireup="false" Inherits="LMS.header" Codebehind="header.aspx.vb" %>
...
<body style="padding:0px; margin:0px">
    ...
    <div style="padding:0; margin:0; background-image:url('images/body-bg.gif'); background-repeat:repeat;">
        <div style="background-color:#2c3848; height:30px; padding:10px 10px 0 10px;">
			...
			<asp:LinkButton ID="btlogout" runat="server" style="float:right;"><img src="Images/btLogOut.png" border="0" title="Log Out" /></asp:LinkButton>
