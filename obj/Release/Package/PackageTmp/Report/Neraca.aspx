<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Neraca.aspx.vb" Inherits="LMS.Neraca" %>
...
<head runat="server">
    <title>LIGITA - Neraca Akhir</title>
  ...
  <script type="text/javascript">
      function viewReports() {
          ...
          window.open('ReportAcc.aspx?rpt=ReportNeraca' + str + "&tipe=" + opt, 'ReportNeraca', windowprops);
      }
  ...
  <div class="div_input" style = "width:20%;">
            ...
            <tr>
                <td>
                    ...
                    <asp:ListItem Value="Semua">Neraca</asp:ListItem>
                    <asp:ListItem Value="Pjk">Neraca Pjk</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
