<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProfitLost.aspx.vb" Inherits="LMS.ProfitLost" %>
...
//  		str = str + "&laststartdate=" + strlaststartdate + "&lastenddate=" + strlastenddate;
  		...
  		window.open('ReportAcc.aspx?rpt=LabaRugi' + str + "&tipe=" + opt, 'LabaRugi', windowprops);
}
  ...
  <div class="div_input" style = "width:30%;">
            ...
            <tr>
                <td>
                    ...
                    <asp:ListItem Value="Semua">Laba Rugi</asp:ListItem>
                    <asp:ListItem Value="Pjk">Laba Rugi Pjk</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
		<table  style = " border: 2px dotted #000000;" width = "90%">
			<tr>
				<td>Tahun :</td>
				<td>
					<dxe:ASPxDateEdit ID="tbDate" ClientInstanceName="tbDate" runat="server" Width="150px" EditFormat="Custom" EditFormatString="yyyy"
