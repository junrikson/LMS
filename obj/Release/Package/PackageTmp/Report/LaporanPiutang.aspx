<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LaporanPiutang.aspx.vb" Inherits="LMS.LaporanPiutang" %>
...
//  						"[" + coaend.options[coaend.selectedIndex].text + "]";
  		...
  		window.open('ReportAcc.aspx?rpt=rptPiutang' + str + "&tipe=" + opt, 'rptPiutang', windowprops);
  	}
  </script>
</head>
<body class="mainmenu">
