<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BLReport.aspx.vb" Inherits="LMS.BLReport" %>
...
<head runat="server">
   ...
   function getMuatReport() {
       returnValue = Showdialogwarehouse('MuatReport', 'Arg', '610', '450');
        if (returnValue) {
            var comp = new Array();
            comp = returnValue.split(";");
            var Name = document.getElementById("hfMRID");
            Name.value = comp[0];
            var Customer = document.getElementById("TxtCustomer");
            Customer.value = comp[2];
        }
    }
    ...
    function printClick() {
        var print = document.getElementById("hfPC");
        print.value = window.prompt("Please input how many copy do you want to print ?", 1);
//        alert(document.getElementById("hfPC").value);
...
<body>
    ...
    <div class = "Divutama">
                ...
                <table>
                   <tr>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td   >
                            <dxe:ASPxDateEdit ID="BLDate" runat="server" EditFormat = "Custom" EditFormatString="dd MMMM yyyy">
                            </dxe:ASPxDateEdit>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <asp:TextBox ID = "TxtKawat" runat = "server" 
                                Height="21px" Width="179px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style = " width : 250px ; ">
        ...
        <div>
            <asp:Panel ID="Panel_HistoryInput" runat ="server">
        ...
        <div>
            <asp:Panel ID="historygrid" runat="server">
             <dxwgv:ASPxGridView ID="Grid_Kapal_History" runat="server" 
                    AutoGenerateColumns="true" Font-Size="9pt" KeyFieldName="Mb_No" 
                    Width="80%" ClientInstanceName = "grid_kapal_history">
                    <styles>
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="WarehouseHeaderID" FieldName="WarehouseHeaderID" Name="WarehouseHeaderID" 
                            Visible="false" VisibleIndex="1">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Customer Id" FieldName="Customer_Id" Name="Customer_Id" 
                            Visible="false" VisibleIndex="2">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Nama Konsumen" FieldName="Nama_Customer" Name="Nama_Customer" 
                             VisibleIndex="3">
                        </dxwgv:GridViewDataTextColumn>
                        ...
                        <dxwgv:GridViewDataDateColumn Caption="Tanggal" FieldName="Tanggal" 
                            Name="Tanggal"  Visible="true" VisibleIndex="6" Width="200px">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Kapal" FieldName="Kapal" 
                          ...
                          <dxwgv:GridViewDataTextColumn Caption="KapalID" FieldName="KapalID" 
                            Name="KapalID"  Visible="false" VisibleIndex="9" Width="140px">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataColumn Caption="#" Name="PrintBL" VisibleIndex="11" Width="1%">
                            <dataitemtemplate>
                                <asp:LinkButton ID="tbPrintBL" runat="server" CommandName="PrintBL" 
                                    ToolTip="Print BL ">PrintBL</asp:LinkButton>
                            </dataitemtemplate>
                    ...
                    <Templates>
                        <DetailRow>
                            <dxwgv:ASPxGridView ID="Grid_Kapal_Child_History" runat="server" 
                                AutoGenerateColumns="true" Font-Size="9pt" KeyFieldName="Mb_No" 
                                Width="569px" ClientInstanceName = "grid_kapal_child_history" onbeforeperformdataselect="Grid_Kapal_Child_History_DataSelect">
                                <styles>
                                    <header backcolor="#2c3848" font-bold="true" forecolor="#FFFFFF" 
                                        horizontalalign="Center" hoverstyle-border-bordercolor="#515763">
                                        <hoverstyle>
