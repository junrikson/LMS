<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LaporanPembayaran.aspx.vb" Inherits="LMS.LaporanPembayaran" %>
...
<head runat="server">
    <title>LIGITA - Laporan Pembayaran</title>
...
//  						"[" + coaend.options[coaend.selectedIndex].text + "]";
  		...
  		window.open('ReportAcc.aspx?rpt=LapPembayaran' + str + "&tipe=" + opt, 'LapPembayaran', windowprops);
  	}
  </script>
</head>
<body class="mainmenu">
   ...
   <div class="formtitle">
        L<strong>aporan Pembayaran</strong>    
    </div>
	<br />
        ...
        <table>
            <tr>
                <td>
                    ...
                    <asp:ListItem Value="Semua">Pembayaran</asp:ListItem>
                    <asp:ListItem Value="Pjk">Pembayaran Pjk</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>
