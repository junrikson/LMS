<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ReportJournal.aspx.vb" Inherits="LMS.ReportJournal" %>
...
//  						"[" + coaend.options[coaend.selectedIndex].text + "]";
  		...
  		window.open('ReportAcc.aspx?rpt=rptJournal' + str + "&tipe=" + opt, 'rptJournal', windowprops);
}
  </script>
</head>
<body class="mainmenu">
