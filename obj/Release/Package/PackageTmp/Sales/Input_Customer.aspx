<%@ Page Language="VB" AutoEventWireup="false" Inherits="LMS.Sales_Input_Customer" Codebehind="Input_Customer.aspx.vb" %>
...
<head runat="server">
    ...
    grid.GetRowValues(grid.GetFocusedRowIndex(), 'ID;CustomerID;NamaBarang;Berat;Lebar;Tinggi', OnGetRowValues);
}
...
function getTujuan() {
    ...
    if (returnValue) {
        ...
        var Name = document.getElementById("TxtKotaDitunjukan");
        Name.value = comp[1];
    }
}
</script>
