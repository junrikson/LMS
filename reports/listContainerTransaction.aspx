<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="listContainerTransaction.aspx.vb" Inherits="LMS.listContainerTransaction" %>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header">
          <h1>Laporan Daftar Transaksi Kontainer
          </h1>
          <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-file-text"></i>Report </a></li>
              <li class="active">Daftar Transaksi Kontainer</li>
          </ol>
      </section>
      ...
      <section class="content">
          ...
          <div class="box box-default color-palette-box">
              <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-file-text"></i> Laporan Daftar Transaksi Kontainer</h3>
              </div>
