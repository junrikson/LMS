...
Public Class rptSubLedgerPiutang
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptSubLedgerPiutang.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMS.rptSubLedgerPiutang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSubLedgerPiutang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSubLedgerPiutang = New rptSubLedgerPiutang()
        rpt.Site = Me.Site
        Return rpt
    End Function
