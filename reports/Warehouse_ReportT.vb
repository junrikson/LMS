...
Public Class Warehouse_ReportT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LMS.Warehouse_ReportT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWarehouse_ReportT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Warehouse_ReportT = New Warehouse_ReportT()
        rpt.Site = Me.Site
        Return rpt
    End Function
