<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Master_Satuan.aspx.vb" Inherits="LMS.Master_Satuan" %>
        ...
        <div class="div_umum">
            ...
            <table >
                <tr>
					...
					<tr>
						<td class="style2"><B>Satuan :</B></td><td class="style1" colspan="2">
						<asp:TextBox ID="tbsatuan" runat="server" CssClass="tb1" Width="150" 
