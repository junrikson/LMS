<%@ Page Language="VB" AutoEventWireup="false" Inherits="LMS.Sales_Input_Harga" Codebehind="Input_Harga.aspx.vb" %>
...
<body class="mainmenu">
    ...
    <div class="Divutama">
        <div class="formtitle"><b>Input Harga</b></div>
        <br />
        <div class="div_input">
        <div class="div_umum">
        <table >
            <tr>
                <td>
					...
					<tr>
						<td class="style2">Nama Harga :</td><td class="style1" colspan="2">
                        <asp:TextBox ID="tbNamaHarga" 
										runat="server" CssClass="tb1" Width="150" MaxLength="100"></asp:TextBox></td>
					</tr>
					<tr>
						<td class="style2">Harga :</td><td class="style1" colspan="2">
						<asp:TextBox ID="tbHarga" runat="server" CssClass="tb1" Width="150" 
        ...
        <asp:HiddenField ID="hfID" runat="server" />
            ...
            <dxwgv:ASPxGridView ID="GridView_Harga" runat="server"  Font-Size = "9pt"	
...
<Paddings PaddingLeft="3px" PaddingTop="1px" PaddingRight="3px" PaddingBottom="1px"></Paddings>
						...
						<Columns>
								...
								<dxwgv:GridViewDataTextColumn Caption="Nama Harga" Name="namaharga" VisibleIndex="1" 
									FieldName="namaharga" Width="20px">
								</dxwgv:GridViewDataTextColumn>
								<dxwgv:GridViewDataTextColumn Caption="Harga" Name="harga" VisibleIndex="2" 
									FieldName="harga" Width="150px">
