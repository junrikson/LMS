<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="footer.ascx.vb" Inherits="LMS.footer" %>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="mailto:junrikson@gmail.com">Logistics Management System</a>.</strong> All rights
    reserved.
  </footer>
