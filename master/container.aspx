<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="container.aspx.vb" Inherits="LMS.container" %>
      ...
      <section class="content">
          ...
          <div class="box box-default color-palette-box">
              <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-truck"></i> Kontainer</h3>
              </div>
    ...
    <form id="form1" runat="server" class="form-horizontal">
                  <div class="box-body">
                      <div class="form-group">
                          <label class="col-sm-2 control-label text-right">Kode Kontainer (*) :</label>
                          <div class="col-sm-10">
                              <asp:TextBox ID="TxtCode" runat="server" CssClass="form-control"></asp:TextBox>
                          </div>
                      </div>
                      <div class="form-group">
                          <label class="col-sm-2 control-label text-right">Nama Kontainer (*) :</label>
                          <div class="col-sm-10">
        ...
        <br />
            <dxwgv:ASPxGridView ID="Grid_Kontainer" runat="server" AutoGenerateColumns = "False" ClientInstanceName = "grid"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Kode Kontainer" FieldName="code" 
                        Name="code"  Visible="true" VisibleIndex="1" Width="140px">
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Nama Kontainer" FieldName="name" 
                        Name="name"  Visible="true" VisibleIndex="2" Width="140px">
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Keterangan" FieldName="note" 
                        Name="note"  Visible="true" VisibleIndex="3" Width="140px">
                    </dxwgv:GridViewDataTextColumn>
