<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="kondisi.aspx.vb" Inherits="LMS.kondisi" %>
      ...
      <section class="content">
          ...
          <div class="box box-default color-palette-box">
              <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-file-text-o"></i> Kondisi Pengiriman</h3>
              </div>
              ...
              <form id="form1" runat="server" class="form-horizontal">
                  <div class="box-body">
                      ...
                      <br />
                      <dxwgv:aspxgridview id="GridView_Kondisi" runat="server" font-size="10pt"
