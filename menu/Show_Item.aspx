<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Show_Item.aspx.vb" Inherits="LMS.Show_Item" %>
...
<body>
  ...
  <div>
		<dxwgv:ASPxGridView ID="grid_Dialog" ClientInstanceName="grid" runat="server" Width="100%" Font-Names="Trebuchet MS" AutoGenerateColumns="False" KeyFieldName="ID">
			<Styles>
				<Header BackColor="#CCD9E9" ForeColor="Black" HorizontalAlign="Center" Paddings-Padding="2px"></Header>
				<Cell HorizontalAlign="Left" Font-Size="11px" VerticalAlign="Top" Paddings-Padding="2px"></Cell>
				<FocusedRow BackColor="#F16A39" ForeColor="White"></FocusedRow>
			</Styles>
			...
			<Columns>
				<dxwgv:GridViewDataColumn FieldName="ID" Caption="ID" VisibleIndex="0" Visible = "false"></dxwgv:GridViewDataColumn>				
				<dxwgv:GridViewDataColumn FieldName="QUOTATION_NO" Caption="Quotation Number" VisibleIndex="1"></dxwgv:GridViewDataColumn>
				<dxwgv:GridViewDataColumn FieldName="NAMA_CUSTOMER" Caption="Nama Kostumer" VisibleIndex="2"></dxwgv:GridViewDataColumn>
				<dxwgv:GridViewDataColumn FieldName="Nama_Barang" Caption="Nama Barang" VisibleIndex="3"></dxwgv:GridViewDataColumn>	
				<dxwgv:GridViewDataColumn FieldName="HARGA" Caption="Harga" VisibleIndex="8"></dxwgv:GridViewDataColumn>				
			</Columns>
		</dxwgv:ASPxGridView>
