<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dialog3.aspx.vb" Inherits="LMS.dialog3" %>
...
function OnGridFocusedRowChanged() {
		...
		grid.GetRowValues(grid.GetFocusedRowIndex(), 'CODE;NAME;QTY;CUSTOMERID', OnGetRowValues);
}
...
function OnGetRowValues(values) {
	...
	document.getElementById("packet_cid").value = values[3];
}
...
function passValue() {
	...
	var cid = document.getElementById("packet_cid");
	var val = packet_code.value + ";" + packet_name.value + ";" + jenis.value + ";" + cid.value ;
//	if(val=="" || val==";") {
////		passValue();
//		//alert('too fast');
...
<body>
  ...
  <div>
		<dxwgv:ASPxGridView ID="grid_Dialog" ClientInstanceName="grid" runat="server" Width="100%" Font-Names="Trebuchet MS" AutoGenerateColumns="False" KeyFieldName="CODE">
			...
			<Columns>
				...
				<dxwgv:GridViewDataColumn FieldName="NAME" Caption="Nama Pengirim" VisibleIndex="1"></dxwgv:GridViewDataColumn>
				<dxwgv:GridViewDataColumn FieldName="QTY" Caption="Quantity" VisibleIndex="2"></dxwgv:GridViewDataColumn>
				<dxwgv:GridViewDataColumn FieldName="CUSTOMERID" Caption="CUSTOMERID" VisibleIndex="3" Visible = "false"></dxwgv:GridViewDataColumn>
			</Columns>
		</dxwgv:ASPxGridView>
  ...
  <input type="hidden" id="packet_cid" />
